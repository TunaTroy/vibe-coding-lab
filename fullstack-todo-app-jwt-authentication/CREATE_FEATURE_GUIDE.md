###
Trước khi làm gì, hãy đọc toàn bộ file trong thư mục memory-bank/ để nắm các quyết
định kiến trúc đã chốt và tiến độ hiện tại của dự án. Sau đó tóm tắt lại cho tôi
những gì bạn vừa nạp được.
